    ...
    <div className="fullContainer w-full h-full flex flex-col">
      ...
      <div className="SecondContainer flex-1 h-full flex w-full text-[#e5e5e5]">
        <div className="leftMainContent w-full flex p-4 md:pl-12 h-full justify-center items-center">
          <div className="upcomingInterviewContainer shadow-xl shadow-zinc-900 rounded-md w-full h-4/5 flex flex-col">
            <div className="upcomingInterviewTop w-full h-1/5 bg-zinc-900 rounded-t-md border-b border-black flex justify-between items-center p-7">
            ...
            <div className="upcomingInterviewContent rounded-b-md bg-zinc-800 flex flex-col w-full h-full justify-center items-center">
        ...
        <div className="rightMainContent w-1/3 h-full flex p-4 md:pl-12 justify-center items-center">
          <div className="interviewStatusContainer shadow-xl shadow-zinc-900 rounded-md w-full h-4/5 flex flex-col">
            <div className="titleSection w-full h-1/5 bg-zinc-900 rounded-t-md border-b border-black flex justify-between items-center p-7">
              <p className="text-xl font-bold">Interview Status</p>
            </div>
            <div className="interviewStatusContent rounded-b-md bg-zinc-800 flex flex-col w-full h-full justify-center items-center">
              <NoData />
            </div>
          </div>
        </div>
