  ...
  return (
    <div className=" grid grid-cols-2 gap-5">
      {items.map((contact, index) => {
        return (
          <div className="h-[30vh] w-[40vw] shadow-black shadow-md bg-gradient-to-r from-neutral-900  to-neutral-800 rounded-md card  flex flex-col p-2 justify-center items-center">
